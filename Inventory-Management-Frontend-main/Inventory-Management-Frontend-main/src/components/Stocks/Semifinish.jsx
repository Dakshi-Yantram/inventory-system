...
function Semifinish(props) {
  ...
  return (
    <div className='semi-finished-container'>
      ...
      <div style={{ height: 470, width: '100%' }} className='raw-material-form-div'>
        <DataGrid
          columns={[
            { field: 'material_id', hideable: false, headerName: 'Material Id', width: '140' },
          ...
          rows={materialFormData.filter((row) => row.type == 'Semi-Finished Goods')}
