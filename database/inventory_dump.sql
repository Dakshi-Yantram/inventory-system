...
CREATE TABLE `users` (
  ...
  `role` enum('admin','store','procurement','viewer') DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,'admin','admin123','admin','2025-11-29 06:59:16');
...
-- Dump completed on 2025-11-29 12:29:37
